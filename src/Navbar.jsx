...
import pic from "/images/logo.png?url";
...
function Navbar() {
  ...
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto px-4 md:px-20 h-16 fixed top-5 left-0 right-0 z-50 bg-white/10 backdrop-blur-lg border-b border-white/10">
        <div className="flex justify-between items-center h-16">
          <div className="flex space-x-2 items-center">
            ...
            <h1 className="font-semibold cursor-pointer">
              <span className="text-gray-600 text-xl md:text-2xl hover:text-blue-600 transition-colors duration-300  font-mono">Ankit Indresh Gupta</span>
